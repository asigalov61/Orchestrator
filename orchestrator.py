...
Original file is located at
    https://colab.research.google.com/drive/1J10gFTEV4Re2A55FVCVMmYjH8EjGxtjk

# Orchestrator (ver. 1.0)
...
composition_orchestration_length_in_notes = 256 #@param {type:"slider", min:8, max:4096, step:8}
temperature = 0.8 #@param {type:"slider", min:0.1, max:1, step:0.1}
