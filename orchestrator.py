...
number_of_tokens_tp_generate = 300 # @param {type:"slider", min:32, max:4096, step:4}
...
number_of_prime_tokens = 300 #@param {type:"slider", min:4, max:3072, step:4}
number_of_tokens_tp_generate = 300 #@param {type:"slider", min:32, max:4096, step:32}
number_of_batches_to_generate = 4 #@param {type:"slider", min:1, max:16, step:1}
temperature = 0.8 #@param {type:"slider", min:0.1, max:1, step:0.1}
...
#@title Stabilized Continuation Generator

#@markdown Play with the settings to find optinal ones for your seed MIDI

#@markdown Increasing number of batches should increase stability/quality of the output but it will slow down the generation proportionally
...
number_of_blocks_to_generate = 64 #@param {type:"slider", min:1, max:512, step:1}
...
print('=' * 90)
print('Orchestrator Composition Orchestration Generator')
print('=' * 90)
...
for i in tqdm.tqdm(range(start_note, len(melody_chords_f1))):
  ...
  #====================================================
    ...
    print('Interrupting orchestration...')
    break
...
for i in tqdm.tqdm(range(number_of_prime_notes, len(melody)-1)):
  ...
  #====================================================
    ...
    print('Interrupting harmonization...')
    break
